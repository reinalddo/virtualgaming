...
function store_config_descriptions(): array {
    $descriptions = [
        ...
        'binance_pagonorte_fecha_corte' => 'Fecha de corte reportada por la API Binance de PagoNorte al consultar el saldo.',
        'binance_pagonorte_activo' => 'Activa o desactiva la visibilidad pública del método Binance PagoNorte dentro del checkout.',
        'binance_pagonorte_image' => 'Ruta de la imagen horizontal usada para representar Binance PagoNorte como metodo de pago en la pagina de paquetes.',
        'binance_pagonorte_corner_image' => 'Ruta de la imagen promocional flotante usada en la esquina de la card publica de Binance PagoNorte.',
        'binance_pagonorte_qr_image' => 'Ruta de la imagen QR mostrada dentro del modal de pago de Binance PagoNorte.',
        'binance_pagonorte_datos' => 'Datos de transferencia mostrados al cliente cuando usa Binance PagoNorte.',

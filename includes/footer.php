...
?>
  ...
  <?php if ($hasWhatsapp || $hasWhatsappChannel): ?>
    <div class="floating-social-stack" aria-label="Accesos rápidos de contacto">
      ...
      <?php endif; ?>
      <?php if ($hasWhatsapp): ?>
        <a href="<?php echo htmlspecialchars($whatsappUrl, ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener noreferrer" class="floating-social-button floating-social-button-whatsapp floating-social-button-circle" aria-label="WhatsApp">
          <span class="floating-social-icon" aria-hidden="true">

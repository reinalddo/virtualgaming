...
('ventana_inicio_juego', '0', 'Activa o desactiva la ventana global que se muestra al entrar a cualquier juego.'),
('ventana_inicio_juego_descripcion', 'Lee la información antes de continuar con la recarga.', 'Texto descriptivo debajo del título principal de la ventana inicial en juegos.'),
('ventana_inicio_juego_modal_background', '#18101e', 'Color de fondo del modal global que se muestra al entrar a un juego.'),
('ventana_inicio_juego_title_color', '#f8b53d', 'Color del título principal de la ventana inicial en juegos.'),
('ventana_inicio_juego_check_text_color', '#e2e8f0', 'Color del texto del bloque de confirmación de la ventana inicial en juegos.'),
('ventana_inicio_juego_check_background_color', '#1e293b', 'Color de fondo del bloque de confirmación de la ventana inicial en juegos.'),
('ventana_inicio_juego_button_text_color', '#0b0f18', 'Color del texto del botón principal de la ventana inicial en juegos.'),
('ventana_inicio_juego_button_background_color', '#c99712', 'Color de fondo del botón principal de la ventana inicial en juegos.'),
('ventana_inicio_juego_button_disabled_text_color', '#0b0f18', 'Color del texto del botón principal inactivo de la ventana inicial en juegos.'),
('ventana_inicio_juego_button_disabled_background_color', '#c99712', 'Color de fondo del botón principal inactivo de la ventana inicial en juegos.'),
